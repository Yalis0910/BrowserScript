...
| :--- | :--- | :--- | :--- | :--- |
| [**WebSnapshotManager**](./WebSnapshotManager) <br> **网站快照存储与恢复助手** | `v1.2.0` | 通用全站 | Cookie（全量/HttpOnly）、LocalStorage、SessionStorage 一键捕获；AES-GCM 硬件级加密；二维码生成展示/扫码识别恢复；多账号极速切换与跨设备导入导出。 | [查看文档](./WebSnapshotManager/README.md) |
