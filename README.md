...
| :--- | :--- | :--- | :--- | :--- |
| [**WebSnapshotManager**](./WebSnapshotManager) <br> **网站快照存储与恢复助手** | `v1.4.1` | 通用全站 | Cookie（全量/HttpOnly）、LocalStorage、SessionStorage 一键捕获；AES-GCM 硬件级加密与 Trusted Types 严格 CSP 兼容；GitHub Gist 云同步；二维码生成展示/分片轮播/扫码识别恢复；多账号极速切换与跨设备导入导出。 | [查看文档](./WebSnapshotManager/README.md) |
